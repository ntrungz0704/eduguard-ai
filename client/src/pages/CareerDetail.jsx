...
function getRecommendedResources(skillName) {
  ...
  if (clean.includes('css animations') || clean.includes('animations')) {
    return {
      ...
      video: 'https://www.youtube.com/watch?v=A2wG_M5V-8U'
    };
  }
  ...
  if (clean.includes('react native') || clean.includes('expo') || clean.includes('flipper') || clean.includes('native modules') || clean.includes('navigation')) {
    return {
  ...
  if (clean.includes('figma to code')) {
    return {
      docs: 'https://help.figma.com/hc/en-us/articles/360039832014-Figma-to-HTML-CSS-code',
      video: 'https://www.youtube.com/watch?v=J1KVPBXhyek'
    };
  }
  if (clean.includes('data fetching')) {
    return {
      docs: 'https://nextjs.org/docs/app/building-your-application/data-fetching',
      video: 'https://www.youtube.com/watch?v=f1rF9YKm1Ms'
    };
  }
  if (clean.includes('ssr/ssg')) {
    return {
  ...
  if (clean.includes('styling') && (clean.includes('next.js') || clean.includes('nextjs'))) {
    return {
      docs: 'https://nextjs.org/docs/app/building-your-application/styling',
      video: 'https://www.youtube.com/watch?v=XIGx1sfvRoc'
    };
  }
  if (clean.includes('routing (app router)') || clean.includes('next.js app router')) {
    return {
  ...
  if (clean.includes('next.js') || clean.includes('nextjs') || clean.includes('routing (app router)') || clean.includes('nextauth') || clean.includes('edge runtime') || clean.includes('ssr/ssg') || clean.includes('middleware') || clean.includes('image/font optimization') || clean.includes('api routes')) {
    return {
  ...
  if (clean.includes('fastify')) {
    return {
      ...
      video: 'https://www.youtube.com/watch?v=b4l0z8B2Rz8'
    };
  }
  ...
  if (clean.includes('postgresql') || clean.includes('postgres')) {
    return {
      ...
      video: 'https://www.youtube.com/watch?v=85pG_pDkITY'
    };
  }
  ...
  if (clean.includes('flutter state management')) {
    return {
      docs: 'https://docs.flutter.dev/data-and-backend/state-mgmt/intro',
      video: 'https://www.youtube.com/watch?v=yklUzYcZXi0'
    };
  }
  if (clean.includes('bloc pattern') || clean.includes('bloc')) {
    return {
      docs: 'https://bloclibrary.dev/',
      video: 'https://www.youtube.com/watch?v=tQ9-VucvqNk'
    };
  }
  if (clean.includes('push notifications') || clean.includes('sqlite') || clean.includes('sqlite (offline storage)')) {
    return {
      docs: 'https://firebase.google.com/docs/cloud-messaging',
      video: 'https://www.youtube.com/watch?v=RuQyWMBp4kI'
    };
  }
  if (clean.includes('flutter') || clean.includes('lifecycle') || clean.includes('layouts & gestures') || clean.includes('widget lifecycle') || clean.includes('animations') || clean.includes('mobile performance') || clean.includes('app store/play store deployment')) {
    return {
      docs: 'https://docs.flutter.dev/',
      video: 'https://www.youtube.com/watch?v=VPvVD8t02U8'
    };
  }
  if (clean.includes('dart') || clean.includes('dart programming')) {
    return {
  ...
  if (clean.includes('azure')) {
    return {
      ...
      video: 'https://www.youtube.com/watch?v=TyWtx7q2D7w'
    };
  }
  if (clean.includes('aws') || clean.includes('cloud deployment') || clean.includes('cloud architecture') || clean.includes('cloud security') || clean.includes('cloud architecture basics') || clean.includes('cloud deployment (aws/vercel)')) {
    return {
      docs: 'https://docs.aws.amazon.com/',
      video: 'https://www.youtube.com/watch?v=3hLmDS1XB9Y'
    };
  }
  if (clean.includes('prompt') || clean.includes('few-shot') || clean.includes('chain-of-thought') || clean.includes('prompt engineering') || clean.includes('prompt evaluation') || clean.includes('few-shot prompting')) {
    return {
      docs: 'https://www.promptingguide.ai/',
      video: 'https://www.youtube.com/watch?v=_ZvnD73m40o'
    };
  }
  if (clean.includes('openai') || clean.includes('gemini') || clean.includes('ai api') || clean.includes('ai apis') || clean.includes('openai/gemini apis') || clean.includes('ai chat ui')) {
    return {
      docs: 'https://ai.google.dev/docs',
      video: 'https://www.youtube.com/watch?v=gB632E2vvfQ'
    };
  }
  if (clean.includes('rag') || clean.includes('retrieval') || clean.includes('retrieval-augmented generation (rag)')) {
    return {
      docs: 'https://blogs.nvidia.com/blog/what-is-retrieval-augmented-generation/',
      video: 'https://www.youtube.com/watch?v=sVcwVQRHIc8'
    };
  }
  if (clean.includes('langchain') || clean.includes('llamaindex') || clean.includes('langchain / llamaindex')) {
    return {
      docs: 'https://js.langchain.com/docs/get_started/introduction',
      video: 'https://www.youtube.com/watch?v=lG7Uxts9SXs'
    };
  }
  ...
  if (clean.includes('agent') || clean.includes('workflows') || clean.includes('agentic workflows') || clean.includes('ai agents')) {
    return {
  ...
  if (clean.includes('linux') || clean.includes('terminal') || clean.includes('cli') || clean.includes('linux cli')) {
    return {
      ...
      video: 'https://www.youtube.com/watch?v=VbEx7B_PTOE'
    };
  }
  if (clean.includes('bash') || clean.includes('bash scripting')) {
    return {
      docs: 'https://www.gnu.org/software/bash/',
      video: 'https://www.youtube.com/watch?v=e7BufAVwDiM'
    };
  }
  if (clean.includes('a11y') || clean.includes('accessibility') || clean.includes('web accessibility') || clean.includes('web accessibility (a11y)')) {
    return {
      docs: 'https://www.w3.org/WAI/fundamentals/accessibility-intro/',
      video: 'https://www.youtube.com/watch?v=20SHvU2PKsM'
    };
  }
  if (clean.includes('seo')) {
    return {
      docs: 'https://developers.google.com/search/docs/fundamentals/seo-starter-guide',
      video: 'https://www.youtube.com/watch?v=xsVTqzratPs'
    };
  }
  ...
  if (clean.includes('postman') || clean.includes('api testing (postman)')) {
    return {
  ...
  if (clean.includes('networking') || clean.includes('networking basics')) {
    return {
  ...
  if (clean.includes('storybook')) {
    return {
      ...
      video: 'https://www.youtube.com/watch?v=x-x47qHq3nY'
    };
  }
  ...
  if (clean.includes('technical writing')) {
    return {
      docs: 'https://developers.google.com/tech-writing',
      video: 'https://www.youtube.com/watch?v=gIHB-7KcKDs'
    };
  }
  if (clean.includes('microservices')) {
    return {
      docs: 'https://microservices.io/',
      video: 'https://www.youtube.com/watch?v=nH4qjmP2KEE'
    };
  }
  if (clean.includes('api design')) {
    return {
      docs: 'https://swagger.io/resources/articles/best-practices-in-api-design/',
      video: 'https://www.youtube.com/watch?v=7nm1pYuKAhY'
    };
  }
  if (clean.includes('rest api') || clean.includes('api integration') || clean.includes('api routes') || (clean.includes('api') && !clean.includes('testing') && !clean.includes('security') && !clean.includes('openai') && !clean.includes('gemini'))) {
    return {
      docs: 'https://developer.mozilla.org/en-US/docs/Glossary/REST',
      video: 'https://www.youtube.com/watch?v=GZvSYJDk-us'
    };
  }
  if (clean.includes('algorithms') || clean.includes('data structures') || clean.includes('algorithms & data structures')) {
    return {
      docs: 'https://github.com/trekhleb/javascript-algorithms',
      video: 'https://www.youtube.com/watch?v=8hly31xKli0'
    };
  }
  if (clean.includes('database design') || clean.includes('database systems')) {
    return {
      docs: 'https://en.wikipedia.org/wiki/Database_design',
      video: 'https://www.youtube.com/watch?v=ztHopE5Wnpc'
    };
  }
  if (clean.includes('llm foundations') || clean.includes('large language models')) {
    return {
      docs: 'https://arxiv.org/abs/1706.03762',
      video: 'https://www.youtube.com/watch?v=lnA9DMvHtfI'
    };
  }
  if (clean.includes('fine-tuning') || clean.includes('fine tuning')) {
    return {
      docs: 'https://huggingface.co/docs/transformers/training',
      video: 'https://www.youtube.com/watch?v=g72H-T-Z4aA'
    };
  }
  if (clean.includes('monitoring') || clean.includes('prometheus') || clean.includes('grafana')) {
    return {
      docs: 'https://prometheus.io/docs/introduction/overview/',
      video: 'https://www.youtube.com/watch?v=r8UvWSX3KA8'
    };
  }
  if (clean.includes('computer science') || clean.includes('cs basics') || clean.includes('computer science basics')) {
    return {
      docs: 'https://en.wikipedia.org/wiki/Computer_science',
      video: 'https://www.youtube.com/watch?v=zOjov-2OZ0E'
    };
  }
  if (clean.includes('performance') || clean.includes('performance optimization') || clean.includes('performance tuning')) {
    return {
      docs: 'https://web.dev/fast/',
      video: 'https://www.youtube.com/watch?v=reztLS3vomE'
    };
  }
