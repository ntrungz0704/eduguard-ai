...
function generateInterventionRoadmap(student, riskData) {
  ...
  if (level === 'CRITICAL') {
    ...
    if (reasons.includes('Nợ môn nền tảng')) roadmap += '- Hỗ trợ thủ tục bảo lưu hoặc rút bớt môn phụ để tập trung trả nợ môn chính.\n';
    ...
    if (reasons.includes('GPA giảm liên tục')) roadmap += '- Phân tích bài tập đang làm kém để gửi tài liệu tham khảo.\n';
